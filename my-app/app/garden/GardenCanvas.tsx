  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            'repeating-linear-gradient(0deg, transparent, transparent 39px, rgba(0,128,0,0.1) 39px, rgba(0,128,0,0.1) 40px), repeating-linear-gradient(90deg, transparent, transparent 39px, rgba(0,128,0,0.1) 39px, rgba(0,128,0,0.1) 40px)',
          ...
          >
            ...
            <div
              className={`absolute rounded-full border-2 ${
                !plant.hasWarning ? 'border-green-500' : 'border-yellow-500'
              } border-opacity-50`}
              style={{
