    ...
    filteredPlants.forEach(plant => {
      if (!transparentImagesRef.current[plant.name]) {
        ...
        img.onload = () => {
          ...
          const canvasSize =
            Math.max(displayWidth, displayHeight, circleRadius * 2) + 20 // Add padding
          ...
          const sizeAdjustedStrokeWidth = Math.max(
            baseStrokeWidth,
            plant.spaceRequired
          )
            ...
            onDragStart={e => {
              ...
              if (transparentImg && transparentImg.complete) {
                e.dataTransfer.setDragImage(
                  transparentImg,
                  transparentImg.width / 2,
                  transparentImg.height / 2
                )
            ...
            <CardContent className='flex items-center space-x-2 p-2'>
              ...
              <div>
                ...
                <p className='text-xs text-gray-500'>
                  {plant.description.substring(0, 47) + '...'}
                </p>
              </div>
            </CardContent>
          </Card>
