...
export default function RightSidebar ({ selectedPlant, onClose, onDelete }) {
  if (!selectedPlant) {
    return (
          ...
          <div className='flex flex-col items-center mb-4'>
            ...
            <div className='w-full bg-green-50 p-3 rounded-md mb-4'>
              ...
              <div className='grid grid-cols-2 gap-2 text-sm'>
                ...
                <span>
                  {Math.floor(selectedPlant.x / 40)}ft{' '}
                  {Math.floor((selectedPlant.x % 40) / (10 / 3))}in.
                </span>
                <span className='text-gray-500'>Y position:</span>
                <span>
                  {Math.floor(selectedPlant.y / 40)}ft{' '}
                  {Math.floor((selectedPlant.y % 40) / (10 / 3))}in.
                </span>
              </div>
            </div>
            ...
            <p>Planting Depth:</p>
            <p className='text-sm text-gray-600 mb-4'>{selectedPlant.depth}</p>
            <p>Notes:</p>
